...
public class CarcontrolApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Verificacao veM4 = new Verificacao(null, v1, p1, 23924, Agua.NORMAL, Oleo.NORMAL, Combustivel.CHEIO, Pneus.BOM_ESTADO, Freios.NORMAL, "Tudo Normal", sdf.parse("28/02/2024"));
		...
		p1.getVerificacoes().addAll(Arrays.asList(veM1, veM2, veM3, veM4));
		p5.getVerificacoes().addAll(Arrays.asList(veL1, veL2, veL3, veL4));
		p7.getVerificacoes().addAll(Arrays.asList(veW1, veW2));
		
		v1.getVerificacoes().addAll(Arrays.asList(veM1, veM2, veM3, veM4));
